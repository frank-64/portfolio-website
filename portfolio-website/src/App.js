            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3>
                  ...
                  >
                    <i class="paneli fa fa-chevron-down" aria-hidden="true"></i>
                  </a>
                </h3>
              </div>
              ...
              <div id="child_mind_panel" class="collapse">
                <div class="panel-body">
                  ...
                  <p>
                    ...
                    CSS, JS and PHP. The website has the following
                    functionality:
                  </p>
                  <div style={{ textAlign: "left" }}>
                    <ul>
                      ...
                      <ul>
                        <li>View bookings</li>
                        <li>Pay for booking using integrated PayPal API</li>
                        <li>Make booking</li>
                        <li>View children</li>
                        <li>Add a child</li>
                        <li>Edit Info</li>
                      ...
                      <li>Admin Account</li>
                      <ul>
                        <li>View/edit/delete user bookings</li>
                        <li>View/edit/delete users</li>
                        <li>View/edit/delete all children</li>
                        <li>Timestamp child arrival for referral</li>
                      </ul>
                    </ul>
                  </div>
                  <strong>
